...
data = get_text_message_input(
    recipient=RECIPIENT_WAID, text="Hello, this is gunjesh."
)
...
data = get_text_message_input(
    recipient=RECIPIENT_WAID, text="Hello, this is a test message gunjesh."
)

loop = asyncio.get_event_loop()
loop.run_until_complete(send_message(data))
# loop.asyncio.run(send_message(data))
loop.close()
